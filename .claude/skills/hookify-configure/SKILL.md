...
> Converted from [`plugins/hookify/commands/configure.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/hookify/commands/configure.md)
