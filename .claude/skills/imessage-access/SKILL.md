...
> Converted from [`external_plugins/imessage/skills/access/SKILL.md`](https://github.com/anthropics/claude-plugins-official/blob/main/external_plugins/imessage/skills/access/SKILL.md)
