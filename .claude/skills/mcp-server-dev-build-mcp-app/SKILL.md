---
name: "mcp-server-dev-build-mcp-app"
...
> Converted from [`plugins/mcp-server-dev/skills/build-mcp-app/SKILL.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/mcp-server-dev/skills/build-mcp-app/SKILL.md)
> in the `mcp-server-dev` plugin of `anthropics/claude-plugins-official` (Apache-2.0).
