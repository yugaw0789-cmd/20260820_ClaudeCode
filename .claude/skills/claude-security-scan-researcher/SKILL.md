---
name: "claude-security-scan-researcher"
...
allowed-tools: ["Read", "Glob", "Grep", "Bash", "Agent(claude-security:explore)"]
---

<!-- generated by tools/plugins_to_skills.py -->

> Converted from [`plugins/claude-security/agents/scan-researcher.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/claude-security/agents/scan-researcher.md)
