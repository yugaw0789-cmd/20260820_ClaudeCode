...
> Converted from [`plugins/hookify/commands/help.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/hookify/commands/help.md)
> in the `hookify` plugin of `anthropics/claude-plugins-official` (Apache-2.0).
>
...
>
> `${CLAUDE_PLUGIN_ROOT}` below resolves to `.claude/plugin-skills/vendor/hookify/` in this repository (except where the text is *teaching* you to write plugins — there it is literal).
