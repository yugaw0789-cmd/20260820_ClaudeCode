...
> Converted from [`plugins/session-report/skills/session-report/SKILL.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/session-report/skills/session-report/SKILL.md)
> in the `session-report` plugin of `anthropics/claude-plugins-official` (Apache-2.0).
