---
name: "code-modernization-security-auditor"
...
> Converted from [`plugins/code-modernization/agents/security-auditor.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/code-modernization/agents/security-auditor.md)
