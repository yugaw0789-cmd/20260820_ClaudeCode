...
> Converted from [`plugins/claude-security/agents/explore.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/claude-security/agents/explore.md)
