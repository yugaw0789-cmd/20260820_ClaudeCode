...
> Converted from [`plugins/project-artifact/skills/project-artifact/SKILL.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/project-artifact/skills/project-artifact/SKILL.md)
> in the `project-artifact` plugin of `anthropics/claude-plugins-official` (Apache-2.0).
