---
name: "code-modernization-modernize-brief"
...
> Converted from [`plugins/code-modernization/commands/modernize-brief.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/code-modernization/commands/modernize-brief.md)
