...
> Converted from [`plugins/claude-code-setup/skills/claude-automation-recommender/SKILL.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/claude-code-setup/skills/claude-automation-recommender/SKILL.md)
> in the `claude-code-setup` plugin of `anthropics/claude-plugins-official` (Apache-2.0).
