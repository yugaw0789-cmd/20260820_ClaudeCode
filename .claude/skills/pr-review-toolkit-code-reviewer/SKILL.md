...
> Converted from [`plugins/pr-review-toolkit/agents/code-reviewer.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/pr-review-toolkit/agents/code-reviewer.md)
