...
> Converted from [`plugins/plugin-dev/skills/plugin-settings/SKILL.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/plugin-dev/skills/plugin-settings/SKILL.md)
