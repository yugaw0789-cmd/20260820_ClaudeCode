...
> Converted from [`external_plugins/discord/skills/configure/SKILL.md`](https://github.com/anthropics/claude-plugins-official/blob/main/external_plugins/discord/skills/configure/SKILL.md)
> in the `discord` plugin of `anthropics/claude-plugins-official` (Apache-2.0).
