...
description: "Use this agent when the user asks to \"create an agent\", \"generate an agent\", \"build a new agent\", \"make me an agent that...\", or describes agent functionality they need. Trigger when user wants to create autonomous agents for plugins. See \"When to invoke\" below for worked scenarios."
allowed-tools: ["Write", "Read"]
---

<!-- generated by tools/plugins_to_skills.py -->

> Converted from [`plugins/plugin-dev/agents/agent-creator.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/plugin-dev/agents/agent-creator.md)
