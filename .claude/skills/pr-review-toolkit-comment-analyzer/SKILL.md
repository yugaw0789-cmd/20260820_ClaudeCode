...
> Converted from [`plugins/pr-review-toolkit/agents/comment-analyzer.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/pr-review-toolkit/agents/comment-analyzer.md)
