...
> Converted from [`plugins/mcp-server-dev/skills/build-mcp-server/SKILL.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/mcp-server-dev/skills/build-mcp-server/SKILL.md)
