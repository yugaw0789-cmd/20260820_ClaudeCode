---
name: "example-plugin-example-skill"
...
> Converted from [`plugins/example-plugin/skills/example-skill/SKILL.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/example-plugin/skills/example-skill/SKILL.md)
