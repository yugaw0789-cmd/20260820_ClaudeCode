---
name: "code-modernization-test-engineer"
...
> Converted from [`plugins/code-modernization/agents/test-engineer.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/code-modernization/agents/test-engineer.md)
