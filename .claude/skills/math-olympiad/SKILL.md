...
> Converted from [`plugins/math-olympiad/skills/math-olympiad/SKILL.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/math-olympiad/skills/math-olympiad/SKILL.md)
> in the `math-olympiad` plugin of `anthropics/claude-plugins-official` (Apache-2.0).
