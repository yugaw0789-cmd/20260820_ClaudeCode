...
> Converted from [`external_plugins/telegram/skills/configure/SKILL.md`](https://github.com/anthropics/claude-plugins-official/blob/main/external_plugins/telegram/skills/configure/SKILL.md)
> in the `telegram` plugin of `anthropics/claude-plugins-official` (Apache-2.0).
