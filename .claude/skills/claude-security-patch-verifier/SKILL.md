---
name: "claude-security-patch-verifier"
...
> Converted from [`plugins/claude-security/agents/patch-verifier.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/claude-security/agents/patch-verifier.md)
