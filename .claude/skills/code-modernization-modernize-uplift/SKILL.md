---
name: "code-modernization-modernize-uplift"
...
> Converted from [`plugins/code-modernization/commands/modernize-uplift.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/code-modernization/commands/modernize-uplift.md)
