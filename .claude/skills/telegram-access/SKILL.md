...
> Converted from [`external_plugins/telegram/skills/access/SKILL.md`](https://github.com/anthropics/claude-plugins-official/blob/main/external_plugins/telegram/skills/access/SKILL.md)
