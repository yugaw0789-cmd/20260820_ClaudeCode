---
name: "code-modernization-modernize-harden"
...
> Converted from [`plugins/code-modernization/commands/modernize-harden.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/code-modernization/commands/modernize-harden.md)
