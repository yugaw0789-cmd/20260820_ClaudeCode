...
> Converted from [`external_plugins/imessage/skills/configure/SKILL.md`](https://github.com/anthropics/claude-plugins-official/blob/main/external_plugins/imessage/skills/configure/SKILL.md)
> in the `imessage` plugin of `anthropics/claude-plugins-official` (Apache-2.0).
