---
name: "claude-security-scan-verifier"
...
> Converted from [`plugins/claude-security/agents/scan-verifier.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/claude-security/agents/scan-verifier.md)
