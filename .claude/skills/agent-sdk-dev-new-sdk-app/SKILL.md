...
> Converted from [`plugins/agent-sdk-dev/commands/new-sdk-app.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/agent-sdk-dev/commands/new-sdk-app.md)
> in the `agent-sdk-dev` plugin of `anthropics/claude-plugins-official` (Apache-2.0).
>
