---
name: "code-modernization-modernize-assess"
...
> Converted from [`plugins/code-modernization/commands/modernize-assess.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/code-modernization/commands/modernize-assess.md)
