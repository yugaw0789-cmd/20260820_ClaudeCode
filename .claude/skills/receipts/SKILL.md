...
> Converted from [`plugins/receipts/skills/receipts/SKILL.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/receipts/skills/receipts/SKILL.md)
> in the `receipts` plugin of `anthropics/claude-plugins-official` (Apache-2.0).
