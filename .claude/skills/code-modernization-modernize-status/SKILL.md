---
name: "code-modernization-modernize-status"
...
> Converted from [`plugins/code-modernization/commands/modernize-status.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/code-modernization/commands/modernize-status.md)
