---
name: "code-modernization-modernize-extract-rules"
...
> Converted from [`plugins/code-modernization/commands/modernize-extract-rules.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/code-modernization/commands/modernize-extract-rules.md)
> in the `code-modernization` plugin of `anthropics/claude-plugins-official` (Apache-2.0).
>
...
>
> `${CLAUDE_PLUGIN_ROOT}` below resolves to `.claude/plugin-skills/vendor/code-modernization/` in this repository (except where the text is *teaching* you to write plugins — there it is literal).
