...
> Converted from [`plugins/pr-review-toolkit/agents/type-design-analyzer.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/pr-review-toolkit/agents/type-design-analyzer.md)
