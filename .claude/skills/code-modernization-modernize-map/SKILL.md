---
name: "code-modernization-modernize-map"
...
> Converted from [`plugins/code-modernization/commands/modernize-map.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/code-modernization/commands/modernize-map.md)
