---
name: "claude-security-patch-generator"
...
allowed-tools: ["Read", "Glob", "Grep", "Bash", "Edit", "Write", "Agent(claude-security:explore)"]
---

<!-- generated by tools/plugins_to_skills.py -->

> Converted from [`plugins/claude-security/agents/patch-generator.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/claude-security/agents/patch-generator.md)
