...
> Converted from [`plugins/plugin-dev/commands/create-plugin.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/plugin-dev/commands/create-plugin.md)
