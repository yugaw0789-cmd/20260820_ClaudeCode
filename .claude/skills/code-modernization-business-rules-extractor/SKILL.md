---
name: "code-modernization-business-rules-extractor"
...
> Converted from [`plugins/code-modernization/agents/business-rules-extractor.md`](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/code-modernization/agents/business-rules-extractor.md)
> in the `code-modernization` plugin of `anthropics/claude-plugins-official` (Apache-2.0).
>
> **This was a subagent definition.** The body is written as a system prompt — follow it as your operating instructions for this task.
